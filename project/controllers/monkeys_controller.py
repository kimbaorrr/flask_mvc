...
page_title = 'Mô hình dự đoán khỉ'
page_dataset_url = 'https://www.kaggle.com/datasets/sarasnchez/monkeys'
page_dataset_name = 'Monkeys'
page_class_names = sorted(['Bald Uakari', 'Emperor Tamarin', 'Mandril', 'Proboscis Monkey', 'White face saki'])
