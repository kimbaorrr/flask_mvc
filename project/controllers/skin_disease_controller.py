...
project_name = 'skin-disease'
page_title = 'Mô hình dự đoán bệnh về da'
page_dataset_url = 'https://www.kaggle.com/datasets/sachinkumar413/monkeypox-images-dataset'
page_dataset_name = 'Skin Disease'
page_class_names = sorted(['Chickenpox', 'Measles', 'Monkeypox', 'Normal'])
